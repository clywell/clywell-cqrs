...
## Affected Package
- [ ] `Clywell.Core.Cqrs` (core abstractions & dispatcher)
- [ ] `Clywell.Core.Cqrs.Generators` (source generator)
- [ ] `Clywell.Core.Cqrs.FluentValidation` (FluentValidation integration)
- [ ] All packages
